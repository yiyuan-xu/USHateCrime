...
From the two graphs on the bachelor rate, especially the Cleveland graph, areas with higher crime rates are more likely to have higher bachelor rates and the smoothing line has a similar slope as one in education level plot. This observation also supports our findings before that with higher educational levels, hate crime rates are supposed to be high too.
