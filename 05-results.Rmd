...
In this part, we study the possible relationship between education level and hate crime. People usually associate a high level of education with a low crime rate in our subconscious mind but the result shown in the first plot is somewhat surprising. Except for a few points, as the level of education increases, the hate crime rate has also an increasing trend. The obvious positive slope of the smooth line also shows that from this graph, education level and hate crime rate are positively correlated.

Since education level is a relatively overall factor and we hope to have a deeper understanding of this factor, we decompose the educational factor into high school graduation rate and undergraduate rate to explore the influethence of basic education and higher education on crime rate. In high_school_rate-hate_crime_rate plot, it is not difficult to see that there is no obvious relationship between the high school education rate and the crime rate. Even if the high school education rate increases, the crime rate remains at a relatively stable level. From the two graphs on the bachelor rate, especially the Cleveland graph, areas with higher crime rates are more likely to have a higher bachelor rate and the smoothing line has a similar slope as one in education level plot.
...
From this plot, we can see that the relationship between income and hate crime rate is very similar to the relationship between education rate and hate crime rate in the previous part. And from the initial overview, it can be seen that the education rate and income do have a very strong correlation. We may conclude that median income has a positive correlation with hate crime as education level.
...
This picture depicts the race composition(the proportion of white people) and hate crime rate. Even if the race rate keeps increasing, the distribution of hate crime still appears chaotic, which shows that the composition of Race/Ehicity does not have a relatively intuitive impact on the hate crime rate.
...
This graph shows the relationship between unemployment rate and hate crime. It can be seen from the best fitting line and point distribution that as the unemployment rate rises, the hate crime rate will also increase slightly, which is consistent with our common sense.
